// ═══ Hekim Plus — Tanıtım sitesi hesaplama motoru ═══
...
// Mouse tekerleği odaklı sayı inputlarında değer değiştirmesin — kaydırma
// yaparken yanlışlıkla değer değişmesi önlenir. Kapsül kapsar tüm number
// inputları (tablo dinamik üretildiği için global delegasyon).
document.addEventListener('wheel', (e) => {
  const el = e.target;
  if (el && el.type === 'number' && document.activeElement === el) {
    el.blur();
  }
}, { passive: true });
