...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function _sonVeriCekimTemizle() {
    try { localStorage.removeItem(HYP_V2_SON_VERI_CEKIM_KEY); } catch (_) {}
    _sonVeriCekimGoster(0);
  }
  ...
  function _hypV2SiteVeriUygula(resp) {
    ...
    _sonVeriCekimKaydet(resp.veriCekimTarihi || resp.guncellenme);
