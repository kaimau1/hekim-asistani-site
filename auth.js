    ...
    <div class="modal-icerik" role="dialog" aria-labelledby="authBaslik" aria-modal="true">
      ...
      <div id="authBaslik" class="auth-modal-baslik">
        ...
        <div>
           ...
           <div class="auth-modal-baslik-alt">Hekim Plus ile giriş yap veya yeni hesap aç</div>
        </div>
      </div>
      ...
      <form class="auth-form" id="authSifirlaForm" data-form="sifirla" novalidate>
         <p class="auth-bilgi">Hekim Plus hesabınıza bağlı e-posta adresinizi girin — sıfırlama bağlantısı gönderelim.<br><small style="color:#d97706">⚠️ Mail gelmezse <b>spam/gereksiz</b> klasörünü kontrol edin.</small></p>
