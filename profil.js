...
function profilGorunumuAyarla(girisVarMi) {
  ...
  const destekMerkeziUst = el('btnDestekMerkeziUst');
  ...
  if (destekMerkeziUst) destekMerkeziUst.hidden = !girisVarMi;
...
function olaylariBagla() {
  ...
  el('btnDestekMerkeziUst')?.addEventListener('click', destekMailiAc);
