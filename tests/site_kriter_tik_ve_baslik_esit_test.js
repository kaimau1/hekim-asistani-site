...
assert(
  index.includes('style.css?v=20260610-mobil-kompakt1') &&
    index.includes('hesapla.js?v=20260610-kriter-tik1'),
  'index.html baslik esitleme + kriter tik cache surumlerini kullanmali.'
);
