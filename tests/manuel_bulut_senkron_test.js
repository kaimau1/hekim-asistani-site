...
assert(maasHtml.includes('maasGirisKaydetCta'), 'maas html: giriş yokken bulut kaydı için giriş CTA olmalı');
assert(maasJs.includes("getElementById('maasBuluttanCek')"), 'maas js: Buluttan Çek handler olmalı');
assert(maasJs.includes('function maasBulutAksiyonlariniGuncelle'), 'maas js: giriş durumuna göre maaş bulut aksiyonlarını güncellemeli');
